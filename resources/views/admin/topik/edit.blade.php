...
@section('title', 'Edit Topik / Bab')
@section('page-title', 'Edit Topik / Bab')
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-6">
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <select id="subject_id" name="subject_id" required
                        ...
                        @foreach($subjects as $s)
                            <option value="{{ $s->id }}" {{ old('subject_id', $topik->subject_id) == $s->id ? 'selected' : '' }}>
                ...
                <div>
                    ...
                    <input type="text" id="name" name="name" value="{{ old('name', $topik->name) }}" required placeholder="Contoh: Aljabar Linier"
                ...
                <div>
                    ...
                    <input type="number" id="order_number" name="order_number" value="{{ old('order_number', $topik->order_number) }}" required min="1"
